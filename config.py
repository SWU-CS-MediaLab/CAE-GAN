...
def get_config():
    ...
    parser.add_argument('--pretrained_model', type=float, default=140.0)
    parser.add_argument('--total_epochs', type=int, default=150, help='total epochs to update the generator')
    parser.add_argument('--train_batch_size', type=int, default=1, help='mini batch size')
    ...
    parser.add_argument('--lr_num_epochs_decay', type=int, default=75, help='LambdaLR: epoch at starting learning rate')
    parser.add_argument('--lr_decay_ratio', type=int, default=75, help='LambdaLR: ratio of linearly decay learning rate to zero')
    ...
    parser.add_argument('--lambda_logit', type=float, default=0.0, help='weight for classifier loss')
    parser.add_argument('--lambda_l1', type=float, default=1.0, help='weight for classifier loss')
    # parser.add_argument('--lambda_latent', type=float, default=10.0, help='weight for cycle loss')
    parser.add_argument('--lambda_lin', type=float, default=0.10, help='weight for classifier loss')
    ...
    parser.add_argument('--num_epochs_start_val', type=int, default=150, help='start validate the model')
    ...
    parser.add_argument('--info_step', type=int, default=150)
